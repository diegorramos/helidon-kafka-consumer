...
abstract class AbstractKafkaConsumerApplicationTest {
    private final Http1Client client;

    protected AbstractKafkaConsumerApplicationTest(Http1Client client) {
        this.client = client;
    }

    @SetUpRoute
    static void routing(HttpRouting.Builder builder) {
        KafkaConsumerApplication.routing(builder);
    }
